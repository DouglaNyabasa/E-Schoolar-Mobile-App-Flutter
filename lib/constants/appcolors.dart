...
class AppColor {
  ...
  static const Color active = Color(0xFFED9B59);
  static const Color disable = Color(0xFF7D8790);
  static const Color whiteBackgroundColor = Color(0xFFFEEFE3);
  ...
  static const Color primaryText1 = Color.fromARGB(255,0, 0, 0);
  static  const Color primary_bg = Color.fromARGB(210,32, 47, 65);
  static const Color primaryTextText = Color.fromARGB(255,255, 255, 255);
  ...
  static const Color primaryThreeSecondaryElementText= Color.fromARGB(255,102, 102, 102);
  static  const Color primaryFourSecondaryElementText = Color.fromARGB(255,204, 204, 204);
